...
Five shipping targets compile and sign with explicit development profiles, Family Controls, and the shared App Group: the containing app, Device Activity Monitor, Shield Configuration, Shield Action, and Device Activity Report. The daily threshold, atomic debit/unshield/re-shield flow, StoreKit delivery, and complete physical-device behavior remain implementation and validation gates. Named Simulator fixtures are explicitly labeled as demo data.
